...
\newcommand{\ghmark}{\raisebox{-0.15em}{\includegraphics[height=0.95em]{figures/github-mark.png}}}

% ---- Title ----
\title{\vspace{-3.5em}\bfseries Canvas Engineering: Declared Causal Macrostructure\\ for Reverse-Diffusion Latent Dynamics}
\author{
  Jacob Valdez \quad \small\href{mailto:jacob@commandagi.com}{\texttt{jacob@commandagi.com}}\\[0.15em]
...
\begin{center}
  \small
  \href{https://github.com/commandAGI/canvas-engineering}{\ghmark\,\texttt{CommandAGI/canvas-engineering}}
  \,$\cdot$\,
