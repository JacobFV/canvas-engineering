...
% Looped-square command glyph (⌘), drawn as four corner loops linked by a square
\newcommand{\cmdglyph}{\raisebox{0.05em}{\begin{tikzpicture}[scale=0.115,line width=0.9pt,line cap=round,line join=round,baseline=0pt]
  \draw (-1,-1) -- (1,-1) -- (1,1) -- (-1,1) -- cycle;
  \draw (-1,-1) circle(0.55);
  \draw (1,-1) circle(0.55);
  \draw (1,1) circle(0.55);
  \draw (-1,1) circle(0.55);
\end{tikzpicture}}}
...
\author{
  ...
  \small\href{https://commandagi.com/research/canvas-engineering}{\texttt{commandagi.com/research/canvas-engineering}}
}
\date{July 2026}
